...
Il problema del conteggio consiste nel, data una Stream sequenza di elementi scelti da un universo $U$, di dimensione $N$, mantenendo un contatore $d$ di elementi distinti visti fino ad ora.
