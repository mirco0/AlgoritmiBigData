...
\end{theorem}
\begin{proof}
    Sia $F_{i,t}$ l'evento in cui il processo $i$ fallisce nell'accesso al database nei round $1,\dots,t$. Poiché i tentativi sono indipendenti tra di loro, si ha che 
    \[
        ...
        \[
            ...
            \]
\end{proof}
Dati questi teoremi come base, è possibile definire la probabilità per cui tutti i processi abbiano successo in $2e\, n \log n$ tentativi
...
Per cui si hanno i dati $\E{Y_{ij}} = \frac{1}{n}, \Pr[Y_{ij} = 1] = \frac{1}{n}$. Inoltre $X_i = \sum_{j=1}^{n}Y_{ij}$ e si definisca $\mu = \E{X_i} = 1$, rappresenta il carico \emph{atteso} del processore $i$.
