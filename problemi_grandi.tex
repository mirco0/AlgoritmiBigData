...
%TODO: creare figura
\input{figure/DISM_window.tex}

La figura \ref{DISM_window} corrisponde al caso peggiore. Nel caso peggiore la query ( la finestra con $\bar{m}$ bit) comprende solamente l'ultimo bit di un blocco, il vero numero di bit \textit{1} nella finestra è $d$. La risposta restituita $\tilde{d}$ include l'intero blocco di $2^k$ bit \textit{1}.
