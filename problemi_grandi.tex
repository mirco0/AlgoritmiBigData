...
Sia $I$ una Stream di bit infiita, con una finestra di lunghezza $N$. Si vuole calcolare il valore della funzione $\#1(I,N,k)$ che rappresenta il numero di \emph{`1'} negli ultimi $k$ bit ($k\leq N$). Una soluzione banale consiste nel memorizzare gli ultimi $N$ bit
\begin{theorem}
